...
const ContactEnhanced = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://t.me/bunsai2212?text=${encodedMessage}`, "_blank");
            ...
            <div className="bg-slate-900/80 backdrop-blur-xl rounded-3xl p-8 border border-slate-700/50 shadow-2xl relative overflow-hidden group">
              ...
              <div className="space-y-4">
                <Button
                  ...
                  onClick={() => window.open("mailto:kaungkhantko2212@gmail.com")}
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm opacity-70">kaungkhantko2212@gmail.com</div>
                  </div>
                </Button>
                ...
                <Button
                  ...
                  onClick={() => window.open("https://github.com/Kaung-Khant-Ko-2212", "_blank")}
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm opacity-70">@Kaung-Khant-Ko-2212</div>
                  </div>
                </Button>
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open("https://www.linkedin.com/in/kaung-khant-ko-a1844b397/", "_blank")
                  }
                >
